import { Box, Button, FormControl, Heading, HStack, Stack, Text, Alert, AlertIcon, AlertTitle, AlertDescription, 
    Flex, Card, CardHeader, CardBody, StackDivider, useToast } from '@chakra-ui/react';
                    ...
                    <Stack spacing='6'>
                        <Stack spacing='6' as='form' onSubmit={formik.handleSubmit}>
                            {error && (
                              ...
                              textAlign='center'>
                              <AlertIcon />
                              <AlertTitle> We are so sorry!</AlertTitle>
