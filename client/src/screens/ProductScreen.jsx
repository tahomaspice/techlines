...
import { Box, Image, Text, Wrap, Stack, Spinner, Alert, AlertIcon, AlertDescription, AlertTitle, 
    Flex, Badge, Heading, HStack, Button, SimpleGrid, useToast, Tooltip, Textarea, Input} from '@chakra-ui/react';
            ...
            product && (
                ...
                <Stack direction={{ base: 'column', lg:'row' }} align={{ lg: 'flex-start'}}>
                    <Stack pr={{ base: '0', md: '12'}} spacing={{ base: '8', md: '4' }} flex='1.5' mb={{ base: '12', md: 'none' }}>
                        ...
                        {product.stock === 0 && (
                        <Badge rounded='full' w='80px' fontSize='0.8em' colorScheme='red'>
                            Sold Out
                        </Badge>)}
                        ...
                        <Stack spacing='5'>
                            ...
                            <Flex w='170px' p='5px' border='1px' borderColor='gray.200' alignItems='center'>
                                ...
                                <Text mx='30px' py='5px'>{amount}</Text>
                            ...
                            <Stack width='270px'>
                                <Flex alignItems='center'>
                                    ...
                                    <Text fontWeight='medium' fontSize='sm' ml='2'>
                                        Free Shipping if order is above $200
                                    </Text>
                                </Flex>
