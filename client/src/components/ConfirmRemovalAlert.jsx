import { Button, AlertDialog, AlertDialogContent, AlertDialogFooter, AlertDialogBody, AlertDialogHeader, 
  ...
  <AlertDialog isOpen={isOpen} leastDestructiveRef={cancelRef} onClose={onClose}>
    <AlertDialogOverlay>
        <AlertDialogContent>
            ...
            <AlertDialogBody>Are you sure? Cannot undo afterwards!</AlertDialogBody>
            <AlertDialogFooter>
