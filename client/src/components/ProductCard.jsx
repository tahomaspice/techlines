import { Flex, Circle, Box, Image, Badge, useColorModeValue as mode, Icon, Button, Tooltip, Stack, Link, HStack, Text, useToast } from '@chakra-ui/react';
...
const addItem = (id) => {
    if(cart.some((cartItem) => cartItem.id === id)) {
        toast({
            description: 'Already in your cart, go to cart to change amount',
            status: 'error',
            isCloseable: true,
        });
    } else {
        dispatch(addCartItem(id, 1))
        toast({description: 'Item has been added.', status: 'success', isCloseable: true })
    }
    };
    return (
    <Stack 
