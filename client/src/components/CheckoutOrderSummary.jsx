...
const CheckoutOrderSummary = () => {
    ...
    const onPaymentError = () => {
        toast({ description: 'Something went wrong with payment. Try again of use different method of payment',
    status: 'error',
    duration: '60000',
    isClosable: true,
    });
  ...
  return (
    <Stack spacing='8' rounded='xl' padding='8' width='full'>
        ...
        <Box align='center'>
            ...
            <Flex justify='center' color={mode('orange.500', 'orange.200')}>
        ...
        <Flex justifyContent='center' my='6' fontWeight='semibold'>
            <p> or </p><Link as={ReactLink} to='/products' ml='1'>
                Continue Shopping
            </Link>
        </Flex> 
