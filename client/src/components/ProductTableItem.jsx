import {Tr, Td, Button, Image, VStack, Textarea, Tooltip, Input, Flex, FormControl, FormLabel, 
    Switch, Badge, useDisclosure} from '@chakra-ui/react';
...
const ProductTableItem = ({product}) => {
    ...
    <Td>
        <Flex direction='column' gap='2'>
            ...
            <FormControl display='flex' alignItems='center'>
                <FormLabel htmlFor='producyIsNewFlag' mb='0' fontSize='sm'>
                    Enable
                ...
                <Switch id='productIsNewFlag' onChange={() => setProductIsNew(!setProductIsNew) } isChecked={productIsNew} />
  ...
  <ConfirmRemovalAlert isOpen={isOpen} onOpen={onOpen} onClose={onClose} cancelRef={cancelRef} 
        itemToDelete={product} deleteAction={deleteProduct} />
  </>
}
